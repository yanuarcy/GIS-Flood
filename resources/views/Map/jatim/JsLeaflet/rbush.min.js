    ...
    })(
        {
            1: [
                function (t, i, n) {
                    ...
                    function c(t, i) {
                        return (
                            (Math.max(i.maxX, t.maxX) -
                                Math.min(i.minX, t.minX)) *
                            (Math.max(i.maxY, t.maxY) -
                    ...
                    e.prototype = {
                        ...
                        insert: function (t) {
                            return (
                                t && this._insert(t, this.data.height - 1), this
                            );
                        },
                        clear: function () {
                        ...
                        _build: function (t, i, n, e) {
                            ...
                            for (
                                M(t, i, n, m, this.compareMinX), s = i;
                                s <= n;
                                s += m
                            )
                                for (
                        ...
                        _chooseSubtree: function (t, i, n, e) {
                            for (var r, a, h, o, s, l, u, m; ; ) {
                                if ((e.push(i), i.leaf || e.length - 1 === n))
                                    break;
                                for (
                                    u = m = 1 / 0, r = 0, a = i.children.length;
                                    r < a;
                                    r++
                                )
                                    (h = i.children[r]),
                        ...
                        _insert: function (t, i, n) {
                            ...
                            for (
                                ...
                                i >= 0 &&
                                a[i].children.length > this._maxEntries;
                        ...
                        _split: function (t, i) {
                            ...
                            var h = this._chooseSplitIndex(n, r, e),
                                o = p(
                                    n.children.splice(h, n.children.length - h)
                                );
                            (o.height = n.height),
                                (o.leaf = n.leaf),
                                a(n, this.toBBox),
                        ...
                        for (; a > n; ) {
                            if (a - n > 600) {
                                var o = a - n + 1,
                                    ...
                                    c = Math.max(
                                        n,
                                        Math.floor(i - (s * f) / o + u)
                                    ),
                                    m = Math.min(
                                        a,
                                        Math.floor(i + ((o - s) * f) / o + u)
                                    );
                                e(t, i, c, m, h);
                            }
                            var d = t[i],
