...
!(function (e, t) {
                    ...
                    return "smart" === o
                        ? (function (e, t, i) {
                              ...
                              if (l.scheme && l.host) {
                                  var m = l.scheme + "://";
                                  if ((g + m).length < h)
                                      return (m + g).substr(0, t);
                              }
                              if (g.length <= t) return g;
                              var A = "";
                              return (
                                  0 < h &&
                                      (A = g.substr(-1 * Math.floor(h / 2))),
                                  (
                                      g.substr(0, Math.ceil(h / 2)) +
                                      i +
                                      A
                                  ).substr(0, h + u)
                              );
                        ...
                        ? (function (e, t, u) {
                              ...
                              return (
                                  0 < r &&
                                      (a = e.substr(-1 * Math.floor(r / 2))),
                                  (
                                      e.substr(0, Math.ceil(r / 2)) +
                                      u +
                                      a
                                  ).substr(0, r + n)
                              );
            ...
            return (
                ...
                (e.prototype.getAnchorText = function () {
                    ...
                    return (
                        ...
                        this.stripPrefix.scheme &&
                            (e = this.stripSchemePrefix(e)),
                ...
                (e.prototype.parseMatches = function (n) {
                    ...
                    function v() {
                        if (h.hasDomainDot) {
                            ...
                            var t = h.hasMailtoPrefix
                                ? e.slice("mailto:".length)
                                : e;
                    ...
                    for (
                        var f,
                            ...
                            t = function () {
                                ...
                                if (0 < a && i && y.wordCharRegExp.test(s))
                                    return "continue";
                                if (
                                    (/\?$/.test(e) &&
                                ...
                                var c = ["http://", "https://"].find(function (
                                    e
                                ) {
    ...
    function P(t, e) {
        ...
        function E(e) {
            ">" === e
                ? ((g = new V(_({}, g, { isClosing: !0 }))), O())
                : (l = 4);
        }
        function k(e) {
            "--" === t.substr(c, 2)
                ? ((c += 2),
                  (g = new V(_({}, g, { type: "comment" }))),
                  (l = 14))
                : "DOCTYPE" === t.substr(c, 7).toUpperCase()
                ? ((c += 7),
                  (g = new V(_({}, g, { type: "doctype" }))),
                  (l = 20))
                : N();
        }
        function T(e) {
    ...
    return (function () {
        function n(e) {
            void 0 === e && (e = {}),
                ...
                (this.email =
                    "boolean" == typeof e.email ? e.email : this.email),
                (this.phone =
                    "boolean" == typeof e.phone ? e.phone : this.phone),
                (this.hashtag = e.hashtag || this.hashtag),
                (this.mention = e.mention || this.mention),
                (this.newWindow =
                    "boolean" == typeof e.newWindow
                        ? e.newWindow
                        : this.newWindow),
        ...
        return (
                    ...
                    "boolean" == typeof e
                        ...
                        : {
                              schemeMatches:
                                  ...
                                  e.schemeMatches,
                              wwwMatches:
                                  "boolean" != typeof e.wwwMatches ||
                                  e.wwwMatches,
                              tldMatches:
                                  "boolean" != typeof e.tldMatches ||
                                  e.tldMatches,
                          }
                );
            }),
            ...
            (n.prototype.parseText = function (e, t) {
                ...
                for (
                    ...
                    for (
                        var i = u[r].parseMatches(e), s = 0, o = i.length;
                        s < o;
                        s++
                    )
            ...
            (n.prototype.createMatchReturnVal = function (e) {
                ...
                return (
                    this.replaceFn &&
                        (t = this.replaceFn.call(this.context, e)),
                    "string" == typeof t
                        ? t
                        : !1 === t
                        ? e.getMatchedText()
