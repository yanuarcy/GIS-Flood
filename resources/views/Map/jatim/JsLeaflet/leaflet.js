...
!(function (t, i) {
    ...
    function Di(t) {
        return (
            ki(t, "mousedown touchstart dblclick", Ri), Ii(t, "click", Gi), this
        );
    }
    function ji(t) {
        return (
    ...
    var ie = te.extend({
            ...
            collapse: function () {
                return (
                    fi(this._container, "leaflet-control-layers-expanded"), this
                );
            },
            _initLayout: function () {
    ...
    var Re = Se.extend({
        ...
        Ne = Re.extend({
            ...
            setStyle: function (t) {
                ...
                return (
                    Re.prototype.setStyle.call(this, t), this.setRadius(i), this
                );
            },
            _project: function () {
    ...
    function Fe(t, i) {
        ...
        switch (r.type) {
            ...
            case "MultiPolygon":
                return (
                    (n = qe(a, "Polygon" === r.type ? 1 : 2, l)), new We(n, i)
                );
